...
from app.app.model_inference import segmentation_inference
from app.app.model_inference import classification_inference
from .utils import log
from .utils import params
from .utils.utils import find_object_coords
import sys
...
from app.app.utils.utils import find_center_coords, find_object_radius
...
def analyze():
    image_path = ui.upload_file(request)
